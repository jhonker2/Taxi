                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> Registrar Clientes
                                ...
                                <div class="row gif_registro">
                                	...
                                	<div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="telefono" placeholder="Ingrese el numero de telefono">
                                            </div>
									...
									<div class="row">
                                         <div class="col-sm-4">
											<button type="button" id="btn_registrar" class="btn btn_taxi">Registrar Cliente</button>
										</div>
									</div>
                                </div>
                            </div>
