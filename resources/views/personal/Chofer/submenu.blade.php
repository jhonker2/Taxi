                ...
                <div class="card" style="margin-bottom: 0.5rem;">
                    <div class="header" style="">
                         <ul class="personal-submenu">
                            <li id="lista_chofer"><img src="{{asset('img/listar.png')}}" alt=""> Listar Chofer &nbsp&nbsp&nbsp&nbsp</li>
                            <li id="registrar_chofer"><img src="{{asset('img/registro.png')}}" alt="">    Registrar Chofer &nbsp&nbsp&nbsp&nbsp</li>
