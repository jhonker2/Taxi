...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
    ...
    <div class="app-body">
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="index.html"><i class="icon-speedometer"></i> Panel de Control <!--<span class="badge badge-info">NEW</span>--></a>
                    </li>
    ...
    <footer class="app-footer">
        <a href="http://coreui.io">JHONY GUAMAN</a> © 2017.
        <span class="float-right">Desarrollo <a href="#">Jhony Guamán</a>
        </span>
    </footer>
